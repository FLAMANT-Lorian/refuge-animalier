    ...
    @if($articles)
        <div>
            @foreach($articles as $index => $article)
                ...
                <article
                    class="py-6 px-4 flex flex-col gap-4 border-b border-b-green-500 first-of-type:border-t first-of-type:border-t-green-500">
                    <div class="flex flex-row justify-between items-center">
                        <h3 class="text-lg font-semibold">
                            {!! $article['title'] !!}
                        </h3>
                        <svg class="pl-2" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path
