...
<div x-data="{show : false}" {!! $attributes->merge(['class' => 'relative flex flex-col gap-1']) !!}>
    ...
    <svg @click="show = !show" :class="show ? 'hidden' : 'block'" class="hover:cursor-pointer absolute right-4 bottom-3" width="24"
    ...
    <svg @click="show = !show" :class="show ? 'block' : 'hidden'" class="hover:cursor-pointer absolute right-4 bottom-3" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
