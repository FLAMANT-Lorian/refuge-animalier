<span {!! $attributes->merge(['class' => '']) !!}>
    ...
    <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        <path class="fill-transparent" d="M6.66699 1.66669V5.00002" stroke="black" stroke-width="1.5" stroke-linecap="round"
              stroke-linejoin="round"/>
        <path class="fill-transparent" d="M13.333 1.66669V5.00002" stroke="black" stroke-width="1.5" stroke-linecap="round"
              stroke-linejoin="round"/>
