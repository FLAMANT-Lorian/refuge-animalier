...
<x-admin.partials.modal>
    ...
    <x-slot:title>
        {{ __('admin/animals.create_note_modal_title') }}
    </x-slot:title>
    ...
    <x-slot:body>
        <form novalidate wire:submit="createNote" class="flex flex-col gap-6">
            <fieldset class="flex flex-col gap-6 md:grid md:grid-cols-2">
                <legend class="sr-only">{{ __('admin/animals.create_note_modal_title') }}</legend>
                ...
                <x-forms.fields.input-text
                    wire="createNoteForm.visit_date"
            ...
            <x-forms.buttons.outlined-button-submit
                :label="__('admin/animals.create_note_modal_btn')"/>
        </form>
    </x-slot:body>
