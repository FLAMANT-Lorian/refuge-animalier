...
<li class="relative p-4 border border-green-300 bg-white hover:bg-green-100 rounded-2xl transition-all ease-in-out duration-200 md:flex md:justify-between md:items-center md:gap-4">
    {{-- TODO: OUVRIR UNE MODAL --}}
    <dl class="flex flex-col md:flex-row gap-4">
        <div class="md:flex md:flex-row md:gap-4 md: items-center md:order-2 md:before:block md:before:content[''] md:before:h-5 md:before:w-0.5 md:before:bg-gray-100">
