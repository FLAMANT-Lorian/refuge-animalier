<fieldset class="flex flex-col gap-4 pt-6 border-t border-t-gray-200">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 min-[68.75rem]:grid-cols-7 gap-6">
        ...
        {{-- MARDI --}}
        <x-forms.fields.input-text
            wire="form.availability.tuesday"
            field_name="tuesday"
            name="tuesday"
        ...
        {{-- MERCREDI --}}
        <x-forms.fields.input-text
            wire="form.availability.wednesday"
        ...
        {{-- JEUDI --}}
        <x-forms.fields.input-text
            wire="form.availability.thursday"
            field_name="thursday"
            name="thursday"
        ...
        {{-- SAMEDI --}}
        <x-forms.fields.input-text
            wire="form.availability.saturday"
            field_name="saturday"
            name="saturday"
