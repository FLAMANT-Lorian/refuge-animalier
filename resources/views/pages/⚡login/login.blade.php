<main
    ...
    <section
        ...
        <figure class="max-md:hidden flex">
            <img src="{!! asset("assets/img/svg/logo/logo_normal.svg") !!}" alt="Logo du refuge">
        </figure>
        <figure class="max-md:flex hidden">
            <img src="{!! asset("assets/img/svg/logo/logo_small.svg") !!}" alt="Logo du refuge">
        </figure>
        <div class="flex flex-col gap-2">
            <h2 class="text-xl font-normal text-center">
                Connexion à votre espace d’administration
            </h2>
            <p class="text-base font-normal text-center">Les champs renseignés avec <strong class="text-red">*</strong>
                sont obligatoires !
            </p>
        </div>
