<main class="dashboard" id="content">
    ...
    <div class="px-6 md:px-12 py-10 flex flex-col gap-6 lg:grid lg:grid-cols-9">

        {{-- FIL D’ARIANE --}}
        <section class="flex items-start flex-col gap-4 lg:col-start-1 lg:col-end-10 lg:p-4 lg:border lg:border-gray-200 lg:rounded-2xl lg:bg-white">
