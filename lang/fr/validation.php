...
return [
    ...
    | comme les règles de taille. N'hésitez pas à ajuster chaque message ici.
    |
    */
    ...
    'lte' => [
        ...
        'file' => 'Le fichier :attribute doit peser moins ou égal à :value kilo-octets.',
        'numeric' => 'La valeur de :attribute doit être inférieure ou égale à :value.',
        'string' => 'Le texte :attribute doit contenir moins ou égal à :value caractères.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | Lignes personnalisées pour la validation
    |--------------------------------------------------------------------------
    |
    | Ici, vous pouvez spécifier des messages de validation personnalisés pour les attributs
    | en utilisant la convention "attribute.rule". Cela permet de définir rapidement
    | un message spécifique pour une règle donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour remplacer le placeholder de l'attribut
    | par quelque chose de plus lisible, comme "Adresse e-mail" au lieu de "email".
    | Cela rend le message plus expressif.
    |
    */
